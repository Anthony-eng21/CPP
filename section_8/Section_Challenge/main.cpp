...
int main() {
    ...
    int balance{}, dollars{}, quarters {}, dimes{}, nickels{}, pennies{}; //our balnce var is what makes our algorithm here run because it's the only variable that is keeping track of the running value (balance lol)
